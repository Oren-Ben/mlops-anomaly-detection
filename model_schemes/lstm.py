...
from model_schemes.lstm_data_prep import LstmDataPrep
from model_schemes.utils import data_spliter
from model_schemes.orig_lstm import Vanilla_LSTM
...
class LstmModel:
    ...
    def train(self, train_set):
        ...
        self.residuals_train = (
            pd.DataFrame(self.y_train - self.trained_model.predict(self.x_train))
            .abs()
            .sum(axis=1)
        )
